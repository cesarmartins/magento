(function() {
	...
	window.Media = {
		...
		moveStates : function(to_form, field) {
			...
			setOptions('quicktime', 'loop,autoplay,cache,controllers,correction,enablejavascript,kioskmode,autohref,playeveryframe,targetcache,scale,starttime,endtime,target,qtsrcchokespeed,volume,qtsrc');
