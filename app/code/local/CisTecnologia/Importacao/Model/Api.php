<?php
class Cistecnologia_Importacao_Model_Api
{
    ...
    public function doCall(){
        ...
        ### CONFIG AREA ###
        $store_url = 'http://186.233.105.20:8085/';
        //http://localhost/PCSIS2699.exe/soap/PC_Produto
        //$store_url = 'https://linkdecomprarommanelpe.shop/index.php/';
        //$wsdl_url = $store_url . 'api/v2_soap/?wsdl';
        //$wsdl_url = $store_url . 'api/soap/?wsdl';
        $wsdl_url = $store_url . 'soap/PC_Produto';
        $api_user = 'csitecnologia';
        $api_key = 'csiwebpass0110!@#';
...
//            'categories' => array(2),
    ...
    public function dadosTesteImplantacao(){

        $array = array("codigo_departamento"=>"1",
            "codigo_secao" => "103",
            "codigo_categoria" => "10302",
            "codigo_subcategoria" => "15",
            "codigo_produto" => "54",
            "codigo_fabrica" => "TPK/AS*CZ2",
            "tipo_codigo_barra_1" => "13",
            "codigo_barra_1" => "7891222039816",
            "descricao" => "ASSENTO ASTR ALMOF TPK/AS*CZ2",
            "peso_bruto" => "0.86998",
            "peso_liquido" => "0.69359");
