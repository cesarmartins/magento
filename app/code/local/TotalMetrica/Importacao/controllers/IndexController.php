...
class TotalMetrica_Importacao_IndexController extends Mage_Adminhtml_Controller_action
{

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('importacao/items')
	...
	public function indexAction() {
        ...
        $this->loadLayout();
        $this->getLayout()->getBlock('importacao');
        $this->renderLayout();
	}
