...
class TotalMetrica_Tree_Model_Produtos {
    ...
    public function insertProdutoSimples($produtos){
        ...
        $price = $this->getPreco($produtos["codigo_produto"]);
        $peso = $produtos["PesoBruto"];
    ...
    public function getPreco($codProduto){

        $retorno = Mage::helper("tree/preco")->getPreco($codProduto);
        return $retorno;
    }
    public function getQuantidade($codProduto){

        $retorno = Mage::helper("tree/quantidade")->getQuantidade($codProduto);
        return $retorno;
    }
    ...
    public function getCategories($category_id, $secao_id){
        ...
        try{
            ...
            if($cadastrar){
                ...
                $retorno = Mage::helper("tree/categoria")->getCategoria($category_id, $secao_id);
