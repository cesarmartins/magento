...
class TotalMetrica_Tree_Model_Tree
{
    ...
    public function insertProdutosPlanilha($arrayLlinha, $existeNoMagento){

        if($existeNoMagento){
            $sql = "INSERT rm_importacao(rm_sku,rm_nome,rm_estoque,rm_desc_produto,rm_data)";
            $sql .= "VALUES(:rm_sku,:rm_nome,:rm_estoque,:rm_desc_produto, now())";
        }else{
            $sql = "INSERT rm_importacao(rm_sku,rm_nome,rm_estoque,rm_loja,rm_colecao,rm_classe,rm_desc_produto,rm_sub_classe,rm_data)";
            $sql .= "VALUES(:rm_sku,:rm_nome,:rm_estoque,:rm_loja,:rm_colecao,:rm_classe,:rm_desc_produto,:rm_sub_classe,now())";
        }
        $data = $arrayLlinha;
    ...
    public function zeraEstoqueImportacao(){
        $this->resource->query('truncate rm_importacao;');
    }
