 ...
 */
class CesarMartins_ProcurarProdutos_Model_Query extends Mage_Core_Model_Abstract
{
    /**
     * Event prefix
     *
    ...
    public function getSuggestCollection()
    {
        ...
        $collection = Mage::getResourceModel('catalog/product_collection')
            ...
            ->addAttributeToFilter('visibility', array('in' => $visibilityModel->getVisibleInSiteIds()))->setPageSize(20);
