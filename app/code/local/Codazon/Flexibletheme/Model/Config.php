...
class Codazon_Flexibletheme_Model_Config extends Varien_Simplexml_Config
{
    ...
    {
        $config = Mage::helper('flexibletheme')->getThemeConfig()->loadModulesConfiguration('theme_system.xml')
            ->applyExtends();

        Mage::dispatchEvent('adminhtml_init_theme_config', array('config' => $config));
