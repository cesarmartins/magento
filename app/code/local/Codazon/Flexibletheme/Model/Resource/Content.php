...
class Codazon_Flexibletheme_Model_Resource_Content extends Codazon_Flexibletheme_Model_Resource_Abstract
{
	
	public function __construct()
    {
        $this->setType(Codazon_Flexibletheme_Model_Content::ENTITY);
