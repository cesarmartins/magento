...
class Codazon_Flexibletheme_Model_Resource_Footer extends Codazon_Flexibletheme_Model_Resource_Abstract
{
	
	public function __construct()
    {
        $this->setType(Codazon_Flexibletheme_Model_Footer::ENTITY);
