...
class Codazon_Flexibletheme_Adminhtml_Flexibletheme_ContentController extends Mage_Adminhtml_Controller_Action
{
	...
	{
		$this->loadLayout()->_setActiveMenu("flexibletheme/content")->_addBreadcrumb(
			Mage::helper("adminhtml")->__("Manage Main Contents"),
	...
	public function indexAction() 
	{
		...
		$this->_title($this->__("Main Content"));
	...
	{	
		...
		$model = Mage::getModel("flexibletheme/content")->setStoreId($storeId)->setStore($storeId)->load($id);
        ...
        $this->_addBreadcrumb($helper->__("Main Content"), $helper->__("Main Content"));
        $this->_setActiveMenu("flexibletheme/content");	
        $this->renderLayout();
    ...
    public function deleteAction()
    {
        if ($id = $this->getRequest()->getParam($this->_idField)) {
            $model = Mage::getModel("flexibletheme/content")->load($id);
            try {
                $model->delete();
