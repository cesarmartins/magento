 ...
 */
class Codazon_Flexibletheme_Block_Adminhtml_System_Config_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _initObjects()
    {
        ...
        $this->_configDataObject = Mage::getSingleton('flexibletheme/config_data');
        $this->_configRoot = $this->_configDataObject->getConfigRoot();
        $this->_configData = $this->_configDataObject->load();

        $this->_configFields = Mage::getSingleton('flexibletheme/config');
        ...
        foreach ($group->fields as $elements) {
            ...
            foreach ($elements as $element) {
                ...
                if ($element->backend_model) {
                    ...
                    if (!$model instanceof Codazon_Flexibletheme_Model_Themeconfig_Data) {
    ...
    public function getConfigRoot()
    {
        if (empty($this->_configRoot)) {
            $this->_configRoot = Mage::getSingleton('flexibletheme/config_data')->getConfigRoot();
        }
     ...
     * to getBlala() methods to be later set from controllers with setters
     */
    /**
     * Enter description here...
     *
