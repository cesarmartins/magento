...
class Codazon_Flexibletheme_Block_Adminhtml_Content_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry('flexibletheme_data')->getId()) {
            ...
            return Mage::helper('flexibletheme')->__('New Content');
        }
    }
}