...
class Codazon_Flexibletheme_Block_Adminhtml_Footer_Edit_Form extends Codazon_Flexibletheme_Block_Adminhtml_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('identifier', 'text', array(
            ...
            'name' => 'identifier',
            'required' => true,
            'note' => $helper->__('This field value is also the folder name of project package. Please consider carefully before modifying this field. The footer style might be broken.
')
        ));
        ...
        $attributes['content']->setNote($helper->__('This content is used for some special footers, not applied to all'));
        
        $this->_setFieldset(array($attributes['title']), $fieldset);
        
        $fieldset->addField('is_active', 'select', array(
            'label'     => $helper->__('Status'),
            'values'    => Codazon_Flexibletheme_Block_Adminhtml_Footer_Grid::getStatus(),
            'name'      => 'is_active'
        ));
        
        $parentOptions = Mage::getModel('flexibletheme/system_config_source_footers');
        ...
        $this->_setFieldset(array($attributes['content'], $attributes['layout_xml']), $fieldset);
