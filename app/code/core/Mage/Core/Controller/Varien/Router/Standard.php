...
class Mage_Core_Controller_Varien_Router_Standard extends Mage_Core_Controller_Varien_Router_Abstract
{
    ...
    public function match(Zend_Controller_Request_Http $request)
    {
        ...
        /**
         * Going through modules to find appropriate controllers
         */
        $found = false;
        foreach ($modules as $realModule) {
            ...
            if ($request->getControllerName()) {
                ...
                if (!empty($p[1])) {
                    ...
                    $controller = $front->getDefault('controllers');
                    $request->setAlias(
    ...
    /**
     * Check if current controllers instance is allowed in current router.
     *
    ...
    protected function _validateControllerClassName($realModule, $controller)
    {
        ...
        // include controllers file if needed
    ...
    /**
     * Include the file containing controllers class if this class is not defined yet
     *
