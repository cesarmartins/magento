 ...
 *
 * Allows dispatching before and after events for each controllers action
 *
...
class Mage_Core_Controller_Request_Http extends Zend_Controller_Request_Http
{
    ...
    /**
     * Specify module name where was found currently used controllers
     *
     * @param   string $module
     * @return  Mage_Core_Controller_Request_Http
     */
    ...
    /**
     * Get module name of currently used controllers
     *
     * @return  string
     */
    ...
    /**
     * Get controllers name used in request (ignore rewrite)
     *
     * @return string
     */
