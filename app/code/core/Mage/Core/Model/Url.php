 ...
 * - route_path: 'module/controllers/action/param1/value1/param2/value2'
 * - route_name: 'module'
...
class Mage_Core_Model_Url extends Varien_Object
{
    ...
    /**
     * Retrieve default controllers name
     *
     * @return string
     */
    ...
    public function getUrl($routePath = null, $routeParams = null)
    {
         ...
         * this method has condition for adding default controllers and action names
