...
class Mage_Core_Model_App_Area
{
    ...
    protected function _loadPart($part)
    {
        ...
        Varien_Profiler::start('mage::dispatch::controllers::action::predispatch::load_area::'.$this->_code.'::'.$part);
        switch ($part) {
        ...
        Varien_Profiler::stop('mage::dispatch::controllers::action::predispatch::load_area::'.$this->_code.'::'.$part);
        return $this;
    }
