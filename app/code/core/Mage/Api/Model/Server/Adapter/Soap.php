    ...
    implements Mage_Api_Model_Server_Adapter_Interface
{
    ...
    /**
     * Set webservice api controllers
     *
    ...
    {
         $this->setData('controllers', $controller);
         return $this;
    }

    /**
     * Retrive webservice api controllers. If no controllers have been set - emulate it by the use of Varien_Object
     *
     * @return Mage_Api_Controller_Action|Varien_Object
     */
    public function getController()
    {
        $controller = $this->getData('controllers');
