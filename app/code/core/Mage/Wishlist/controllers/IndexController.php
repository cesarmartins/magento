...
class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
{
    ...
    /**
     * If true, authentication in this controllers (wishlist) could be skipped
     *
     * @var bool
     */
    ...
    /**
     * Set skipping authentication in actions of this controllers (wishlist)
     *
