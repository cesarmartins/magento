...
class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _loginPostRedirect()
    {
        ...
        $carrinhoSession = Mage::getSingleton('core/session')->setOrigem('carrinho');
        if($session->isLoggedIn() && $carrinhoSession->origem == 'carrinho'){
            //$session->setCustomerAsLoggedIn( $session->getCustomer() );
            $this->_forceRedirect(Mage::getBaseUrl() . 'oscheckout', $this);
            $session->setBeforeAuthUrl(Mage::getBaseUrl() . 'oscheckout');
            return $this;
        }else{
    ...
    function _forceRedirect($url, $that) {
