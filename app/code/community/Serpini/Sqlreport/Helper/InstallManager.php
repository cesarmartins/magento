...
{
	protected $versionSql2Report = "0.4.5"; 
	...
	public function getDbSchema ($fromVersion, $returnComplete=false)
	{
		...
		if( version_compare("0.4.0",$actualVersion)>0){
			...
			$instructions = array_merge(
					$instructions,
						...
						,array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "cronFilePath"),array("sql-column", "value", Mage::getBaseDir('media') . DS . 'serpini_sqlreport'. DS . 'emails'))))
		...
		if( version_compare("0.4.3",$actualVersion)>0){
			$actualVersion = "0.4.3";
			$instructions = array_merge(
					$instructions,
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "cronFileName"),array("sql-column", "type", "varchar")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfPageSize"),array("sql-column", "value", "A4")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfPageOrientation"),array("sql-column", "value", "Portrait")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfPageMarginTop"),array("sql-column", "value", "20")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfPageMarginLeft"),array("sql-column", "value", "20")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfPageMarginBottom"),array("sql-column", "value", "20")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfPageMarginRight"),array("sql-column", "value", "20")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfLogoMarginTop"),array("sql-column", "value", "0")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfLogoMarginLeft"),array("sql-column", "value", "0")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfTitleMarginTop"),array("sql-column", "value", "0")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfTitleMarginLeft"),array("sql-column", "value", "20")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfDescriptionMarginTop"),array("sql-column", "value", "10")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfFiltersMarginLeft"),array("sql-column", "value", "0")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfFiltersMarginTop"),array("sql-column", "value", "0")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfTableMarginTop"),array("sql-column", "value", "10")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfTableMarginLeft"),array("sql-column", "value", "0")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfTableMarginRight"),array("sql-column", "value", "0")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfFooterMarginTop"),array("sql-column", "value", "10")))),
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "pdfFooterMarginBottom"),array("sql-column", "value", "0")))),
					
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfPageSize"),array("sql-column", "type", "varchar")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfPageOrientation"),array("sql-column", "type", "varchar")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfPageMarginTop"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfPageMarginLeft"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfPageMarginBottom"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfPageMarginRight"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfLogoMarginTop"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfLogoMarginLeft"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfTitleMarginTop"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfTitleMarginLeft"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfDescriptionMarginTop"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfFiltersMarginLeft"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfFiltersMarginTop"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfTableMarginTop"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfTableMarginLeft"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfTableMarginRight"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfFooterMarginTop"),array("sql-column", "type", "int")))),
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "pdfFooterMarginBottom"),array("sql-column", "type", "int")))),
					
					array(array("type" => "insert", "name" => "sqlrpt_report_type", "items" =>array(array("sql-column", "type_code", "chart_seriefix"),array("sql-column", "type", "int"))))
					);
		}
		
		if( version_compare("0.4.5",$actualVersion)>0){
			$actualVersion = "0.4.5";
			$instructions = array_merge(
					$instructions,
					array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "showSQLReadOnly"),array("sql-column", "value", "false"))))
					);
		}
