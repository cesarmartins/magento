...
class Serpini_Sqlreport_Model_PdfTable_Row {
		...
		if($this->_width){
			...
			if($inContentArea){
				$max_row_width=$page->getWidth()
							-$page->getMargin(Serpini_Sqlreport_Model_PdfTable_Pdf::LEFT)
							-$page->getMargin(Serpini_Sqlreport_Model_PdfTable_Pdf::RIGHT)
							-$this->_margin[Serpini_Sqlreport_Model_PdfTable_Pdf::LEFT]
							-$this->_margin[Serpini_Sqlreport_Model_PdfTable_Pdf::RIGHT];
			}
			else{
				$max_row_width=$page->getWidth();
			}
	...
	public function setBackgroundColor($color){
		foreach ($this->_cols as $col){
			$col->setBackgroundColor(new Zend_Pdf_Color_Html($color));
		}
	}
