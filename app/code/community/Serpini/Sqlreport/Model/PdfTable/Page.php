...
class Serpini_Sqlreport_Model_PdfTable_Page extends Zend_Pdf_Page {
	...
	public function setLogo(Serpini_Sqlreport_Model_PdfTable_Logo $_logo){
		$this->_logo=$_logo;
	}
	
	public function setDocument(Serpini_Sqlreport_Model_PdfTable_Document $document){
	...
	public function getLogoHeight(){
		return $this->hasLogo()?$this->_logo->getHeight()+$this->_logo->getMarginTop():0;
	}
	
	public function getTitleHeight(){
		return $this->_document->getTitleHeight();
	}
	
	public function getFooterHeight(){
		return $this->_document->getFooterHeight();
	}
	...
	private function getLogoTitleHeight(Serpini_Sqlreport_Model_PdfTable_Page $page){
		$logo=0;
		if($page->hasLogo()){
	...
	public function setResults(Serpini_Sqlreport_Model_PdfTable_Table $table,$posX,$posY,$inContentArea=true){
		$altoLogoTitle=$this->getLogoTitleHeight($this);
		$this->addTable($table, 0, $posY+$altoLogoTitle,$inContentArea);
	}
	public function addTable(Serpini_Sqlreport_Model_PdfTable_Table $table,$posX,$posY,$inContentArea=true){
