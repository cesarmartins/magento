...
CREATE TABLE IF NOT EXISTS `{$warehouseShippingCarrierTable}` (
  ...
  KEY `FK_WA IF NOT EXISTSREHOUSE_SHIPPING_CARRIER_WAREHOUSE` (`warehouse_id`), 
...
$installer->run(
    "
CREATE TABLE IF NOT EXISTS `{$warehouseCustomerGroupTable}` (
  `warehouse_id` smallint(6) unsigned not null, 
...
$installer->run(
    "
CREATE TABLE IF NOT EXISTS `{$warehouseCurrencyTable}` (
  `warehouse_id` smallint(6) unsigned not null, 
...
$installer->run(
    "
CREATE TABLE IF NOT EXISTS `{$productBatchPriceTable}` (
  `product_id` int(10) unsigned not null, 
  `stock_id` smallint(6) unsigned not null, 
...
$installer->run(
    "
CREATE TABLE IF NOT EXISTS `{$productIndexBatchPriceTable}` (
...
$installer->run(
    "
CREATE TABLE IF NOT EXISTS `{$productBatchSpecialPriceTable}` (
  `product_id` int(10) unsigned not null, 
  `stock_id` smallint(6) unsigned not null, 
  `website_id` smallint(5) unsigned not null default 0, 
  `price` decimal(12,4) null default null, 
...
$installer->run(
    "
CREATE TABLE IF NOT EXISTS `{$productIndexBatchSpecialPriceTable}` (
  `entity_id` int(10) unsigned not null, 
  `stock_id` smallint(6) unsigned not null, 
  `website_id` smallint(5) unsigned not null default 0, 
  `price` decimal(12,4) null default null, 
