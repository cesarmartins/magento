...
/**
 * Assigned area multiple assignment method
 * 
 * @category   MP
 * @package    MP_Warehouse
 * @author     MP Team <mageplugins@gmail.com>
 */
class MP_Warehouse_Model_Warehouse_Assignment_Method_Multiple_AssignedArea 
    extends MP_Warehouse_Model_Warehouse_Assignment_Method_Multiple_Abstract
{
    ...
    public function applyQuoteStockItems($quote = null)
    {
        ...
        $priorities             = $helper->getAreaStockPriorities($address);
