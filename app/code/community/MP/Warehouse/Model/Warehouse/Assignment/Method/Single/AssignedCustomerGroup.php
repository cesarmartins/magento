 ...
 */
class MP_Warehouse_Model_Warehouse_Assignment_Method_Single_AssignedCustomerGroup
    extends MP_Warehouse_Model_Warehouse_Assignment_Method_Single_Abstract
{
    /**
     * Get stock id
     * 
