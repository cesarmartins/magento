 ...
 */
class MP_Warehouse_Block_Adminhtml_Catalog_Product_Edit_Tab_Shelf 
    extends Mage_Adminhtml_Block_Widget_Form
{
     ...
     * 
     * @return MP_Warehouse_Block_Adminhtml_Catalog_Product_Edit_Tab_Shelf
     */
    protected function _prepareForm()
    {
        ...
        $shelvesElement = $fieldset->addField(
            'shelves', 'text', array(
            'name' => 'shelves', 
