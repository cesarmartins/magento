 ...
 */
class MP_Warehouse_Block_Adminhtml_Catalog_Product_Edit_Tab_Shipping
    extends Mage_Adminhtml_Block_Widget_Form
{
     ...
     * 
     * @return MP_Warehouse_Block_Adminhtml_Catalog_Product_Edit_Tab_Shipping
     */
    protected function _prepareForm()
    {
        ...
        $stockShippingCarriersElement = $fieldset->addField(
            'stock_shipping_carriers', 'text', array(
