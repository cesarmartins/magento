    ...
    public function create()
    {
        ...
        if (!file_exists($file)) {
            ...
            throw new Zend_Tool_Project_Context_Exception(
                'Could not create action within test controllers ' . $file
...
\$this->assertQueryContentContains(
    'div#view-content p',
    'View script for controllers <b>' . \$params['controllers'] . '</b> and script/action name <b>' . \$params['action'] . '</b>'
    );
EOS;
        }
        ...
        $codeGenFile->getClass()->setMethod(array(
            ...
            'body' => <<<EOS
\$params = array('action' => '$actionParam', 'controllers' => '$controllerParam', 'module' => '$moduleParam');
...
\$this->assertController(\$urlParams['controllers']);
