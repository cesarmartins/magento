...
/**
 * Represents a page that is defined using module, controllers, action, route
...
class Zend_Navigation_Page_Mvc extends Zend_Navigation_Page
{
     ...
     * that is found in the front controllers.
     *
    ...
    public function isActive($recursive = false)
    {
        if (null === $this->_active) {
            ...
            if (null !== $this->_controller) {
                $myParams['controllers'] = $this->_controller;
            } elseif (!array_key_exists('controllers', $myParams)) {
                $myParams['controllers'] = $front->getDefaultControllerName();
            }
    ...
    /**
     * Sets controllers name to use when assembling URL
     *
     * @see getHref()
     *
     * @param  string|null $controller    controllers name
     * @return Zend_Navigation_Page_Mvc   fluent interface, returns self
     * @throws Zend_Navigation_Exception  if invalid controllers name is given
     */
    public function setController($controller)
    {
        if (null !== $controller && !is_string($controller)) {
            #require_once 'Zend/Navigation/Exception.php';
            throw new Zend_Navigation_Exception(
                'Invalid argument: $controllers must be a string or null'
            );
        }
    ...
    /**
     * Returns controllers name to use when assembling URL
     *
     * @see getHref()
     *
     * @return string|null  controllers name or null
     */
