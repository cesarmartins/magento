...
abstract class Zend_Controller_Request_Abstract
{
    ...
    /**
     * Controller key for retrieving controllers from params
     * @var string
     */
    protected $_controllerKey = 'controllers';
    ...
    /**
     * Set the controllers name to use
     *
     * @param string $value
     * @return Zend_Controller_Request_Abstract
     */
