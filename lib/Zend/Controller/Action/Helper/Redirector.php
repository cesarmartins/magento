...
class Zend_Controller_Action_Helper_Redirector extends Zend_Controller_Action_Helper_Abstract
{
    ...
    /**
     * Set a redirect URL of the form /module/controllers/action/params
     *
     * @param  string $action
    ...
    /**
     * Perform a redirect to an action/controllers/module with params
     *
     * @param  string $action
     * @param  string $controller
     * @param  string $module
    ...
    /**
     * Perform a redirect to an action/controllers/module with params, forcing an immdiate exit
     *
     * @param  mixed $action
     ...
     * $this->_helper->redirector($action, $controllers, $module, $params)
     *
     * @param  string $action
     * @param  string $controller
     * @param  string $module
