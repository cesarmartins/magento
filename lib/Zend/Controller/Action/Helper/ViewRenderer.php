 ...
 *   subdirectories named after the controllers
 * - viewSuffix: what view script filename suffix to use
 *
 * The helper autoinitializes the action controllers view preDispatch(). It
 ...
 *
 * // In your action controllers methods:
 * $viewHelper = $this->_helper->getHelper('view');
 *
 * // Don't use controllers subdirectories
...
class Zend_Controller_Action_Helper_ViewRenderer extends Zend_Controller_Action_Helper_Abstract
{
    ...
    /**
     * Whether or not to autorender using controllers name as subdirectory;
    ...
    /**
     * Whether or not to use a controllers name as a subdirectory when rendering
     * @var boolean
     */
    protected $_noController    = false;

    /**
     * Whether or not to autorender postDispatch; per controllers/action setting (reset
     * at next invocation)
     * @var boolean
     */
    ...
    /**
     * Characters representing path delimiters in the controllers
     * @var string|array
     */
     ...
     * @var string
     */
    protected $_viewScriptPathSpec = ':controllers/:action.:suffix';

    /**
     * View script path specification string, minus controllers segment
     * @var string
     */
        ...
        if (null === $this->_inflector) {
            ...
            $this->_inflector->setStaticRuleReference('moduleDir', $this->_moduleDir) // moduleDir must be specified before the less specific 'module'
                 ->addRules(array(
                     ...
                     ':controllers' => array('Word_CamelCaseToDash', new Zend_Filter_Word_UnderscoreToSeparator('/'), 'StringToLower', new Zend_Filter_PregReplace('/\./', '-')),
    ...
    /**
     * Retrieve base path based on location of current action controllers
     *
     * @return string
     */
    protected function _getBasePath()
    {
        ...
        $parts = array(
            ...
            'controllers' => $request->getControllerName(),
     ...
     * - noController - flag indicating whether or not to look for view scripts in subdirectories named after the controllers
    ...
    public function initView($path = null, $prefix = null, array $options = array())
    {
        ...
        // Register view with action controllers (unless already registered)
     ...
     * - :controllers - name of current controllers in the request
    ...
    /**
     * Set view script path specification (no controllers variant)
     *
     * Specification can contain one or more of the following:
     * - :moduleDir - current module directory
     * - :controllers - name of current controllers in the request
     ...
     * - :module - name of current module in the request
     *
     * :controllers will likely be ignored in this variant.
     *
     * @param  string $path
     * @return Zend_Controller_Action_Helper_ViewRenderer Provides a fluent interface
     */
    ...
    /**
     * Retrieve the current view script path specification string (no controllers variant)
     *
     * @return string
     */
    ...
    /**
     * Set the noController flag (i.e., whether or not to render into controllers subdirectories)
     *
     * @param  boolean $flag
     * @return Zend_Controller_Action_Helper_ViewRenderer Provides a fluent interface
     */
    ...
    /**
     * Set the neverController flag (i.e., whether or not to render into controllers subdirectories)
     *
     * @param  boolean $flag
     * @return Zend_Controller_Action_Helper_ViewRenderer Provides a fluent interface
     */
     ...
     * @param  boolean $noController Whether or not to render within a subdirectory named after the controllers
     * @return Zend_Controller_Action_Helper_ViewRenderer Provides a fluent interface
     */
     ...
     * - :controllers - current controllers name
