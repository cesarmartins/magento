...
/**
 * Helper for rendering output of a controllers action
 *
 * @package    Zend_View
 * @subpackage Helper
 * @copyright  Copyright (c) 2005-2015 Zend Technologies USA Inc. (http://www.zend.com)
...
class Zend_View_Helper_Action extends Zend_View_Helper_Abstract
{
    ...
    public function __construct()
    {
        ...
        if (empty($modules)) {
            ...
            $e = new Zend_View_Exception('Action helper depends on valid front controllers instance');
            $e->setView($this->view);
            throw $e;
        }
        ...
        if (empty($request) || empty($response)) {
            #require_once 'Zend/View/Exception.php';
            $e = new Zend_View_Exception('Action view helper requires both a registered request and response object in the front controllers instance');
            $e->setView($this->view);
            throw $e;
        }
    ...
    /**
     * Retrieve rendered contents of a controllers action
     *
